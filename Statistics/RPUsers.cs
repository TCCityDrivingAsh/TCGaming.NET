...
{
    /// <summary>
    /// Portraits a collection of RPUser objects
    /// </summary>
    public class RPUsers : GlobalParameters, IReadOnlyCollection<BaseUserWithValue>
    {
        #region Constructors
        /// <summary>
        /// Initialize a new instance RPUsers
        /// </summary>
        public RPUsers()
        {
        ...
        /// </summary>
        private static string _endPoint = @"/citydriving/stats/rp";

        /// <summary>
        /// Stores the RPUser objects for this set
        /// </summary>
        ...
        /// <summary>
        /// Gets the count of RPUser items in the collection
        /// </summary>
