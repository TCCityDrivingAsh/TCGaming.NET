...
{
    /// <summary>
    /// Portraits a collecction of RobberXPUser objects
    /// </summary>
    public class RobberXPUsers : GlobalParameters, IReadOnlyCollection<BaseUserWithValue>
    {

        #region Constructors
        /// <summary>
        /// Initialize a new instance RobberXPUsers
        /// </summary>
        public RobberXPUsers()
        {
        ...
        /// </summary>
        private static string _endPoint = @"/citydriving/stats/robber_xp";
        ...
        /// <summary>
        /// Gets a <see cref="BaseUserWithValue"/> from the collection by a users [TC] World User ID
        /// </summary>
        ...
        /// <summary>
        /// Gets the count of RobberXPUser items in the collection
        /// </summary>
