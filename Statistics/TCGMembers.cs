...
{
    /// <summary>
    /// Portraits a collection of BaseTCMember objects
    /// </summary>
    public class TCGMembers : GlobalParameters, IReadOnlyCollection<BaseTCMember>
    {

        #region Constructors
        /// <summary>
        /// Initialize a new instance TCGMembers
        /// </summary>
        public TCGMembers()
        {
        ...
        /// </summary>
        private static string _endPoint = @"/citydriving/stats/tcgmembers";
        ...
        /// <summary>
        /// Gets the count of BaseTCMember items in the collection
        /// </summary>
